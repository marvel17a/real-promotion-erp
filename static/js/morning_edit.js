/**
 * This is a simpler JavaScript file specifically for the 'morning_edit.html' page.
 * It does not need the 'fetch' logic, but it needs all the row calculation logic.
 */
...
document.addEventListener("DOMContentLoaded", () => {
     ...
     * This version adds a 'new_item' hidden input.
     */
    function createRow(productData = {}) {
        ...
        tr.innerHTML = `
            ...
            <td class="text-start">
                ...
                <!-- This hidden input tells the backend this is a NEW item, not an existing one -->
    ...
    ui.tableBody.addEventListener("click", e => {
        if (e.target.closest(".btn-remove-row")) {
            ...
            if (confirm("Are you sure you want to remove this product from the allocation?")) {
