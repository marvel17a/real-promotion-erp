...
def fetch_evening_data():
    ...
    try:
        ...
        if existing_record:
            ...
            # 2. New Form: Check Morning Alloc
            ...
            if today_alloc:
                ...
                if last_settle:
                    ...
                    return jsonify({'status': 'error', 'message': 'No stock history found.'})
        ...
        if draft_data:
            # Helper: Convert decimals/dates for JSON
